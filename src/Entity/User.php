...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Property::class, mappedBy="landlord", orphanRemoval=true)
     */
    private $properties;

    /**
     * @ORM\OneToMany(targetEntity=Agreement::class, mappedBy="landlord", orphanRemoval=true)
     */
    private $agreements;
    ...
    public function removeAgreement(Agreement $agreement): self
    {
        if ($this->agreements->removeElement($agreement)) {
            // set the owning side to null (unless already changed)
            if ($agreement->getLandlord() === $this) {
                $agreement->setLandlord(null);
            }
        }
